...
def initialize_deepspeed(model):
...
model, optimizer = initialize_deepspeed(model)
model_ref, _ = initialize_deepspeed(model_ref)
reward_model, _ = initialize_deepspeed(reward_model)
value_model, _ = initialize_deepspeed(value_model)
